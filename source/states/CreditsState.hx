...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Moons Discord Server',		'discord',	"Come join Moon's discord server if you want!",							'https://discord.gg/BW9B3nrYuF',	'5165F6'],
			[''],
			['Extra Credits'],
			['Unholywanderer04', 'unholy', 'Unholy Engine Sprites', 'https://x.com/Unholy_wanderer', 'FCC258'],
			['Maru', 'maru', 'Botplay Icon', 'https://x.com/maybemaru_', '378AC2'],
			...
			['KadeDev', 'kade', 'Kade Engine assets', 'https://gamebanana.com/members/1774971', '64A250'],
			[''],
			["Psych Engine Team"],
