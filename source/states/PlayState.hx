...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		precacheList.set('badnoise1', 'sound');
		precacheList.set('badnoise2', 'sound');
		precacheList.set('badnoise3', 'sound');
	...
	public function goodNoteHit(note:Note):Void
	{
		...
		if(note.rating <= 'bad' && ClientPrefs.data.badSounds) {
			FlxG.sound.play(Paths.soundRandom('badnoise', 1, 3), FlxG.random.float(0.2, 0.4)); //testing "bad" sound effects. May use this for an official release later
		}
